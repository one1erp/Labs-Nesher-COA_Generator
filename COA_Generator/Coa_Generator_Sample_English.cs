...
namespace COA_Generator
{
    ...
    [ComVisible(true)]
    [ProgId("COA_Generator.Coa_Generator_Sample_English")]
    public class Coa_Generator_Sample_English : IEntityExtension
    {
        ...
        public void Execute(ref LSExtensionParameters Parameters)
        {
            try
            {
                ...
                //Get sdg
                var sdg = common.GetSample(long.Parse(samplesIDs.First())).Sdg;
                bool b = false;
                if (common.GetSample(long.Parse(samplesIDs.First())).Status == "C")
                {
                    b = common.LoginCOA("COA_GeneratorAllSamples", sdg, false, common.GetSample(long.Parse(samplesIDs.First())).Name);
                }
                else if (common.GetSample(long.Parse(samplesIDs.First())).Status == "P")
                {
                    b = common.LoginCOA("COA_GeneratorAllSamples", sdg, true, common.GetSample(long.Parse(samplesIDs.First())).Name);
                    //b = common.LoginCOA("Partial COA", sdg, true, sample.Name);   
                }
                //var b = common.LoginCOA("Partial COA", sdg, true);
                if (!b)
                {
